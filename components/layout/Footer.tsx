            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <p className="text-zinc-400 mb-2">Sri Lanka</p>
                        <p className="text-zinc-400 mb-2">+94 123 456 789</p>
                        <p className="text-zinc-400 mb-2">info@excellentgroup.com</p>
                    </div>
                </div>

                <div className="pt-10 border-t border-zinc-800 flex flex-col md:row justify-between items-center text-sm text-zinc-500">
